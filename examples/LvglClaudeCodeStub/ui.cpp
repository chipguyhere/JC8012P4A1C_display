 ...
 *
 * A clean starting point for building an LVGL application on the JC8012P4A1C
 * (800x1280 portrait capacitive touchscreen).  Replace the body of ui_init()
 ...
 *     the panel's color order (RGB vs BGR) is correct.
 *
