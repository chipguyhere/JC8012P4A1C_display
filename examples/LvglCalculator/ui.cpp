/*
 * ui.cpp - A dark, iOS-styled four-function calculator for the JC8012P4A1C,
 *          written in plain LVGL 9.
 *
 * ---------------------------------------------------------------------------
 * Resolution independence
 * ---------------------------------------------------------------------------
 * Nothing here is pinned to a resolution.  build_keypad() reads the live
 * display resolution and derives every dimension from it:
 *
 ...
 *
 * A portrait aspect ratio is assumed as the design target, but the same code
 * lays out a proportionate keypad on this 800x1280 panel and on much smaller
 * boards alike: the keys grow with the width and the extra vertical space
 * simply makes the number display roomier.
 *
